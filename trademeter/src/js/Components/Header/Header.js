            ...
            <figure className="user header__user submenu-parent">
              ...
              <ul className="submenu">
                <li className="submenu-item">
                  <a href="https://fani144.ru/kpd/" target="_blank">КПД</a>
                </li>
                <li className="submenu-item">
                  <a href="https://fani144.ru/trademeter/" target="_blank">Трейдометр</a>
                </li>
                <li className="submenu-item">
                  <a href="https://fani144.ru/tor/" target="_blank">Калькулятор ТОР</a>
                </li>
